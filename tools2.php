<?php
define('UPDATE_PAY_USER_NAME','http://www.qiankunzhifu.com/api/pay/updateOrderPayUsername');
define('RECORD_USER_VISITE_INFO','http://www.qiankunzhifu.com/api/pay/recordVisistInfo');
